                      ...
                      <tr>
                        <td class="footable-first-visible">
                          <a href="#" target="_blank">
                            <div>
                              <img src="{{url('public/assets/frontend/images/categry/banner21.jpg')}}" alt="" style="width: 204px">
                            </div>
                          </a>
                        </td>
                        <td>
              ...
              <div class="col-md-5" style="margin-left: 769px">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <a href="{{route('frontend.checkout.view')}}" class="btn btn-checkout btn-primary btn-lg btn-block" style="background-color: #213854; border: none;">
                      Go to checkout
                    </a>
