                ...
                <nav aria-label="breadcrumb" style="margin: 0 auto;">
                    <ol class="breadcrumb d-flex justify-content-center">
                        ...
                        <li class="breadcrumb-item active pt-1" aria-current="page"
                            style="color: #01b7e0; font-size: 14px;">Privacy Policy</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 p-tag">
                <h3 class="fw-bold custom-text-color">
                    ...
                    <p> - At CoolCare Service, accessible from https://www.coolcareservice.in/, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document contains types of
                        information that is collected and recorded by CoolCare Service and how we use it.</p>
                    ...
                    <p> - This Privacy Policy applies only to our online activities and is valid for visitors to our
                        website with regards to the information that they shared and/or collect in CoolCare Service.
                    ...
                    <p> - CoolCare Service follows a standard procedure of using log files. These files log visitors
                    ...
                    <p> - Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                        Beacons that are used in their respective advertisements and links that appear on CoolCare
                        Service, which are sent directly to users' browser. They automatically receive your IP address
                    ...
                    <p> - Note that CoolCare Service has no access to or control over these cookies that are used by
                        third-party advertisers.</p>
                    <h5 class="fw-bold custom-text-color">Third Party Privacy Policies</h5>
                    <p> - CoolCare Service's Privacy Policy does not apply to other advertisers or websites. Thus, we
                    ...
                    <p> - CoolCare Service does not knowingly collect any Personal Identifiable Information from
