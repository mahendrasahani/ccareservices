...
@section('main-section')
 ...
 <section class="owl-carousel" id="owl-carousel">
            <div class="item"><img src="{{url('public/assets/frontend/images/coolcare-banner-1920x685.jpg')}}" alt="Image 1"></div>
            <div class="item"><img src="{{url('public/assets/frontend/images/coolcare-banner-1920x685.jpg')}}" alt="Image 2"></div>
                        ...
                        <div class="row">
                          ...
                          <div class="col">
                            <div class="card hover-item" id="media-product">
                              <a href="#" class="text-decoration-none">
                              <img src="{{url('public/assets/frontend/images/categry/coolcare-heater (1).jpg')}}" class="card-img-top" alt="...">
                              <div class="card-body" style="padding: 7px;">
                  ...
                  <div class="col-md-12 mt-5" id="hiddenContent" style="display: none;">
                    <div class="row">
                      <div class="col" id="media-product">
                        <div class="card hover-item">
                          <a href="" class="text-decoration-none">
                          <img src="{{url('public/assets/frontend/images/categry/chair-on-rent.jpg')}}" class="card-img-top" alt="...">
                          <div class="card-body" style="padding: 7px;">
                      ...
                      <div class="col" id="media-product">
                        <div class="card hover-item">
                          <a href="#" class="text-decoration-none">
                          <img src="{{url('public/assets/frontend/images/categry/table-on-rent.jpg')}}" class="card-img-top" alt="...">
                          <div class="card-body" style="padding: 7px;">
                      ...
                      <div class="col" id="media-product">
                        <div class="card hover-item">
                          <a href="#" class="text-decoration-none">
                          <img src="{{url('public/assets/frontend/images/categry/sofa-on-rent.jpg')}}" class="card-img-top" alt="...">
                          <div class="card-body" style="padding: 7px;">
                      ...
                      <div class="col" id="media-product">
                        <div class="card hover-item">
                          <a href="#" class="text-decoration-none">
                          <img src="{{url('public/assets/frontend/images/categry/wardrobe-on-rent.jpg')}}" class="card-img-top" alt="...">
                          <div class="card-body" style="padding: 7px;">
                    ...
                    <div class="row mt-3">
                        <div class="col-3" id="media-product">
                          <div class="card hover-item">
                            <a href="#" class="text-decoration-none">
                            <img src="{{url('public/assets/frontend/images/categry/coolcare-laptop.jpg')}}" class="card-img-top" alt="...">
                            <div class="card-body" style="padding: 7px;">
                        ...
                        <div class="col-3" id="media-product">
                            <div class="card hover-item">
                              <a href="#" class="text-decoration-none">
                              <img src="{{url('public/assets/frontend/images/categry/bed-on-rent-1.jpg')}}" class="card-img-top" alt="...">
                              <div class="card-body" style="padding: 7px;">
            ...
            <div class="container mt-5">
              <div class="row">
                ...
                <div id="my-unique-carousel" class="owl-carousel"> 
                    <div class="card">
                      <img src="{{url('public/assets/frontend/images/WINDOW AC ON RENT IN GURGAON/LG-Window-AC-12000-BTU-Cooling-Heating-LW1216HR-600x600.jpg')}}" class="card-img-top" alt="...">
                    ...
                    <div class="card">
                      <img src="{{url('public/assets/frontend/images/WINDOW AC ON RENT IN GURGAON/LG-Window-AC-12000-BTU-Cooling-Heating-LW1216HR-600x600 (1).jpg')}}" class="card-img-top" alt="...">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-content-center" style="height: 41px;">
                          <a href="#" class="text-decoration-none">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="owl-carousel" id="brand-slider">
                    <div class="item mt-3" ><img src="{{url('public/assets/frontend/images/brand img/10-185x88.png')}}" alt="Image 1" class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/12-185x88.png')}}" alt="Image 2"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/14-185x88.png')}}" alt="Image 3"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/16-185x88.png')}}" alt="Image 4"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/3-185x88.png')}}" alt="Image 5"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/5-185x88.png')}}" alt="Image 6"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/7-185x88.png')}}" alt="Image 7"  class="w-75"></div>
                    <div class="item mt-3"><img src="{{url('public/assets/frontend/images/brand img/9-185x88.png')}}" alt="Image 8"  class="w-75"></div>
                    <!-- Add more items as needed -->
                  </div>
                </div>
              </div>
