...
input.btn.px-4.btn-outline-dark{
...
input.btn.px-4.btn-outline-dark:hover{
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card" style=" border: 1px solid #dbdbdb;">
                                ...
                                <div class="card-body">
                                    <form class="row mb-3" method="POST" action="{{route('backend.admin.update_admin_profile')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6 p-3">
                                            <input required placeholder="first name" type="text" class="form-control" name="name" id="name" value="{{$profile->name ?? ''}}">
                                        </div>
                                        
                                        <div class="col-md-6 p-3">
                                            <input required placeholder="E-mail" type="email" class="form-control" name="email" id="email" value="{{$profile->email ?? ''}}">
                                        </div>
                                        <div class="col-md-6 p-3">
                                            <input required placeholder="phone" type="tel" class="form-control" name="phone" id="phone" value="{{$profile->phone ?? ''}}">
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card" id="aside">
                                <div class="card-header" style="border-bottom: 1px solid white !important;">
                                    <h3 class=" text-dark text-center">Upload Your Profile</h3>
                                </div>
                                <div class="card-body " style="border: 1px solid #ededed; background: #ededed;">
...
<script>
        $(document).ready(function() {
            ...
            // Prevent the click event on profile-pic if it's a child of upload-button
            $(".upload-button").on('click', function(e) {
                e.stopPropagation();
            });
    
            // Handle the click event on profile-pic separately
