                            ...
                            <div class="d-flex align-items-center" style="border-bottom: 1px solid #ececec;">
                                    ...
                                    <div class="col-md-2 ml-auto">
                                        <div class="form-group mt-2 mb-2">
                                            <select class="form-control form-control-sm" name="type" id="sort_by" name="sort_by">
                                                ...
                                                <option value="price_high_to_low" {{isset($_GET['sortBy']) && $_GET['sortBy'] == 'price_high_to_low' ? 'selected':''}}>Base Price (High > Low)</option>
                                                <option value="price_low_to_high" {{isset($_GET['sortBy']) && $_GET['sortBy'] == 'price_low_to_high' ? 'selected':''}}>Base Price (Low > High)</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                            ...
                                            <th style="display: table-cell;">
                                                <div class="form-group">
                                                    <div class="form-check-inline">
                                                        <input type="checkbox" class="form-check-input check-all" name="main_checkbox">
                                    ...
                                    <tbody id="main_table_body">
                                        ...
                                        <tr id="row_id_{{$product->id}}">
                                            <td style="display: table-cell;">
                                                <div class="form-group">
                                                    <div class="form-check-inline">
                                                        <input type="checkbox" class="form-check-input check-one" name="product_ids[]" value="{{$product->id}}">
                                                        <label class="form-check-label"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><label class="switch">
                                                ...
                                                <td class="text-right footable-last-visible ">
                                                    ...
                                                    <a class="btn btn-soft-success btn-icon btn-circle btn-sm eye_3"
                                                        href="javascript:void()" title="Duplicate" onclick="cloneRow({{$product->id}})">
