                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" name="product_name" placeholder="Product Name" id="product_name"  value="{{$product_detail->product_name ?? ''}}" required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" class="form-control" name="min_qty" min="1" value="{{$product_detail->min_purchase_qty ?? '1'}}"  id="min_qty" placeholder="Product Minimum Purchase Qty." required>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="number" class="form-control" name="max_qty" min="1" value="{{$product_detail->max_purchase_qty ?? '1'}}"  id="max_qty" placeholder="Product Maximum Purchase Qty." required>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="file-preview box sm d-flex">
                                                    ...
                                                    <div class="" data-id="2353" title="534.webp">
                                                        <div class="">
                                                            <img src="{{url('public/'.$image)}}" class="img-fit w-75">
                                                        </div>
                                                        <div class="col body">
                                                            <!-- <h6 class="d-flex"><span class="text-truncate title">534</span><span
                                                                    class="ext flex-shrink-0">.webp</span></h6>
                                                            <p>41 KB</p> -->
                                                        </div>
                                        ...
                                        <div class="no_product_variant">
                                            <div class="form-group row">
                                                <label class="col-md-3 col-from-label">Regular price <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-md-8">
                                                    <input type="number" step="1" min="1" value="{{$product_detail->regular_price}}" placeholder="Product Price" name="product_price" id="product_price" class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-from-label">SKU</label>
                                                <div class="col-md-8">
                                                    <input type="text" placeholder="SKU" name="sku" class="form-control" value="{{$product_detail->sku ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select class="form-control" id="stock_status" name="stock_status" required>
                                                        <option value="1" {{$product_detail->stock_status == 1 ? 'selected' : ''}}>In Stock</option>
                                                        <option value="0" {{$product_detail->stock_status == 0 ? 'selected' : ''}}>Out of Stock</option>
                                                    </select>
                                ...
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" min="1" step="1" placeholder="Discount"
                                                    name="discount" class="form-control" required value="{{$product_detail->discount ?? ''}}">
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group"> 
                                                    <select class="form-control" id="discount_type" name="discount_type">
                                                        <option value="flat" {{$product_detail->discount_type == 'flat' ? 'selected' : ''}}>Flat</option>
                                                        <option value="percent" {{$product_detail->discount_type == 'percent' ? 'selected' : ''}}>Percent</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                        <div id="container">
                                            <textarea id="editor" name="product_description">{{$product_detail->product_description ?? ''}}</textarea> 
                                        </div>
                                ...
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    @php
                                        $attribute_name_list = App\Models\Backend\Attribute::whereIn('id', $product_detail->attribute_name)->get();
                                    @endphp
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <select class="asf selectpicker form-control"  data-live-search="true" title="Main Category" name="product_attributes[]">
                                            <option selected value="{{$attr_name->id}}">{{$attr_name->name}}</option>
                                        </select>
                                      </div>
                                  </div>
                                    @php
                                        $arr = explode(",", $product_detail->attribute_value[$key]);
                                        $attribute_val_list = App\Models\Backend\AttributeValue::whereIn('id', $arr)->get();
                                    @endphp
                                  <div class="col">
                                      <div class="form-group">
                                          ...
                                          <option selected value="{{$val_name->id}}">{{$val_name->name}}</option>
                                          @endforeach
                                        </select>
                                      </div>
                                  </div>
                                ...
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" name="meta_title" placeholder="Meta Title" value="{{$product_detail->meta_title ?? ''}}"> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">Description</label>
                                            <div class="col-md-9">
                                                <textarea name="meta_description" id="meta_description" row="8">{{$product_detail->meta_description ?? ''}}</textarea>
                                            </div>
                                        </div>
                                            <div class="form-group row">
                                                <label class="col-md-3 col-form-label">Slug</label>
                                                <div class="col-md-8">
                                                    <input type="text" placeholder="Slug" id="slug" name="slug" class="form-control" value="{{$product_detail->slug ?? ''}}">
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                        <select class="form-control" id="product_status" name="product_status">
                                            <option value="1" {{$product_detail->product_detail == 1 ? 'selected' : ''}}>Published</option>
                                            <option value="0" {{$product_detail->product_detail == 0 ? 'selected' : ''}}>Draft</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="card" style="border: 1px solid #e8e8e8;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @foreach($brand_list as $brand)
                                            <option value="{{$brand->id}}" {{$product_detail->brand == $brand->id ? 'selected' : ''}}>{{$brand->name}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                                        ...
                                                        <li data-id="0">
                                                            <div class="product-card">
                                                                <span>
                                                                    ...
                                                                    <input type="checkbox" class="main_checkbox" id="main_cat_{{$key}}" name="main_categories[]" onchange="checkAllBox('main_cat_{{$key}}', 'sub_checkbox_{{$key}}')" value="{{$main_cat->id}}" {{in_array($main_cat->id, $product_detail->main_category) ? 'checked':''}}>
                                                            ...
                                                            <div id="sub_cat_list_{{$key}}" class="sub_cat_list">
                                                                ...
                                                                <div class="product-card">
                                                                    <span>
                                                                        <input type="checkbox" class="checkInside0 sub_checkbox_{{$key}}" name="sub_categories[]" value="{{$sub_cat->id}}" onchange="removeAllCheckBox('main_cat_{{$key}}', 'sub_checkbox_{{$key}}')" {{in_array($sub_cat->id, $product_detail->sub_category) ? 'checked':''}}>
