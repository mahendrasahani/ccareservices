                    ...
                    <div class="row mt-5">
                        <div class="col-md-12 mt-5 mx-auto">
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{route('backend.tax.store')}}" enctype="multipart/form-data"> 
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" placeholder="Tax Rate" name="tax_rate" class="form-control" required>
                                            </div>
                                        </div> 
