                                        ...
                                        @foreach($sub_cat_list as $sub_cat)
                                            <tr id="cat_list_{{$sub_cat->id}}"> 
                                                ...
                                                <td class="footable-last-visible">
                                                    <a class="btn btn-soft-info btn-icon btn-circle btn-sm eye-2" href="{{route('backend.sub_category.edit', [$sub_cat->id])}}" title="Edit"><i class="fa-regular fa-pen-to-square"></i></a>
