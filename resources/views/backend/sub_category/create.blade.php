                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" style="border: 1px solid #cccccc;">
                            ...
                            <div class="card-body">
                                <form class="p-4" action="{{route('backend.sub_category.store')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="ordering_number" class="form-control" id="ordering_number" placeholder="Order Level">
