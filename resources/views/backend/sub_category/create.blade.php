            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card" style="border: 1px solid #cccccc;">
                        ...
                        <div class="card-body">
                            <form class="p-4" action="{{route('backend.sub_category.store')}}" method="POST"
                                ...
                                <div class="form-group row mt-2">
                                    ...
                                    <div class="col-md-9">
                                        <select class="selectpicker form-control" name="main_category"
                                            data-live-search="true" title="Main Category" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="ordering_number" class="form-control"
                                            id="ordering_number" placeholder="Order Level">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            <input type="file" class="selected-files form-control" name="meta_image" onchange="displaySelectedImagesSec(event)"> 
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="dropdown bootstrap-select show-tick select2 form-control aiz-">
                                            <select class="selectpicker form-control aiz-selectpicker"
                                                name="filtering_attributes[]" title="Select attributes"
                                                data-toggle="select2" data-live-search="true" multiple="">
