...
.text-right {
    ...
    <table class="table table-bordered">
      <thead>
        <tr>
          <td style="width: 50%;"><b>Shipping Details</b></td>
          <td style="width: 50%;"><b>Billing Details</b></td>
        </tr>
      </thead>
      <tbody>
        <tr>
    ...
    <table class="table table-bordered">
      ...
      @foreach($order->getOrderProduct as $product)
        ...
        <tr>
          ...
          <td class="text-right">₹{{$order->promo_discount ?? '0'}}</td>
        </tr>
      <tr>
          <td class="text-right" colspan="3"><b>Total</b></td>
          <td class="text-right">₹{{number_format($order->total - $order->promo_discount, 2)}}</td>
        </tr>
