...
<body style="background:#e3e9ff; padding-top: 13px; padding-bottom: 20px;">
    ...
    <div class="invoice"
        ...
        <div style="justify-content:space-between; display:flex; width:100%">
            <div class="logo">
                <img src="https://bhartiyaparampara.com/img/logo.png" alt="logo" style="width:200px;">
            </div>
    ...
    <b>
        <p >Sincerely,<br>Your Service Team</p>
    </b>
</div>
        ...
        <div class="main-section" style="text-align:center;">
            <ul style="list-style:none; margin-top: 30px; padding-left:0px !important">
                <li style="display:inline-block;  padding-right: 10px; font-size: 14px;"><a
                        href="https://bhartiyaparampara.com/pages/about-us"
                        style="text-decoration:none; color: #777777;" target="_blank">About Us</a></li>
                <li style="display:inline-block; padding-left: 10px; padding-right: 10px; font-size: 14px;"><a
                        href="https://bhartiyaparampara.com/pages/contact-us"
                        style="text-decoration:none; color: #777777;" target="_blank">Contact Us</a></li>
                <li style="display:inline-block; padding-left: 10px; font-size: 14px;"><a
                        href="https://bhartiyaparampara.com/pages/our-policy"
                        style="text-decoration:none; color: #777777;" target="_blank">Our Policy</a></li>
            </ul>
            <p>© Copyright 2020 Bhartiya Parampara</p>
        </div>
    </div>
    </div>
